  ...
  return (
    <div className="panel rounded-md overflow-hidden">
      <div className="flex items-center justify-between px-5 py-3.5 border-b border-hairline">
        <div>
          <h2 className="font-display text-lg text-foreground leading-tight">Live Intelligence Feed</h2>
          <p className="text-[11px] text-muted-foreground">Continuously surfacing matches across the open web.</p>
        </div>
                  ...
                  <td className="px-5 py-3 align-middle">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <a
                          href="#"
                          onClick={(e) => { e.preventDefault(); e.stopPropagation(); console.log("open", row.suspect.source); }}
